...
class __TwigTemplate_df5a2bdc6fc59bdc1bcb298aa1f50921a7b2287106a484dc2452d0bf2a33d364 extends Template
{
    private $source;
    private $macros = [];
    ...
    <input type=\"text\" value=\"";
        ...
        echo "\" name=\"mailAdress\" id=\"inputMailAdress\" class=\"form-control\" autocomplete=\"username\" required autofocus>
...
<form method=\"post\">
    ...
    <h1 class=\"h3 mb-3 font-weight-normal\">Please sign in</h1>
    <label for=\"inputMailAdress\">Mail Adress</label>
    <input type=\"text\" value=\"{{ last_username }}\" name=\"mailAdress\" id=\"inputMailAdress\" class=\"form-control\" autocomplete=\"username\" required autofocus>
    <label for=\"inputPassword\">Password</label>
    <input type=\"password\" name=\"password\" id=\"inputPassword\" class=\"form-control\" autocomplete=\"current-password\" required>
...
{% endblock %}
", "security/login.html.twig", "/home/skander/Downloads/fitnessnyi_web-main (1)/fitnessnyi_web-main/templates/security/login.html.twig");
    }
}
