...
class __TwigTemplate_e41a47c05fb89a7c33900f73b8daebaa0a397c55f0e55e9f614e4c467a92deea extends Template
{
    private $source;
    private $macros = [];
...
{% block captcha_widget %}
    {% apply spaceless %}
        ...
        {{ form_widget(form, { 'id': user_input_id, 'value': '' }) }}
    {% endapply  %}
{% endblock %}", "@Captcha/captcha.html.twig", "/home/skander/Downloads/fitnessnyi_web-main (1)/fitnessnyi_web-main/templates/bundles/CaptchaBundle/captcha.html.twig");
    }
}
