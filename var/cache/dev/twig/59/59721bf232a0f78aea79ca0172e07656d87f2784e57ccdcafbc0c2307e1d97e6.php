        ...
        {#            <center class=\"col-lg-8\" >
                        <div class=\"card\">
                            <center><div class=\"card-header\">
                                <strong>Ajouter un régime</strong>
                            </div>
                            <div class=\"card-body card-block\">
                                <form action=\"\" method=\"post\" enctype=\"multipart/form-data\" class=\"form-horizontal\">
                                    ...
                                    <div class=\"row form-group\">
                                        <div class=\"col col-md-3\"><label for=\"text-input\" class=\" form-control-label\">Nom de régime</label></div>
                                        <div class=\"col-12 col-md-9\"><input type=\"text\" id=\"text-input\" name=\"text-input\" placeholder=\"Text\" class=\"form-control\"><small class=\"form-text text-muted\">This is a help text</small></div>
                                    </div>
                                    <div class=\"row form-group\">
                                        <div class=\"col col-md-3\"><label for=\"text-input\" class=\" form-control-label\">Type de régime</label></div>
                                        <div class=\"col-12 col-md-9\">
                                    ...
                                    <div class=\"row form-group\">
                                        <div class=\"col col-md-3\"><label for=\"textarea-input\" class=\" form-control-label\">Régime</label></div>
